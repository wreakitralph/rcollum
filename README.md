...
## Target Roles: IT Support Specialist | Cloud Engineer | Network Administrator | Junior Systems Administrator | SOC Analyst

## 🛠️ Technical Skills
- Operating Systems: Windows, Linux (Ubuntu)
- Networking: TCP/IP, DNS, DHCP, VLANs
- Cloud: Microsoft Azure / AWS Fundamentals
- Cybersecurity: Access Control, Hardening, Vulnerability Basics
